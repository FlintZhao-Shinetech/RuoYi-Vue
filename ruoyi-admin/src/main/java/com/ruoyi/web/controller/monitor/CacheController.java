...
public class CacheController
{
    ...
    public AjaxResult getInfo() throws Exception
    {
        ...
        Optional<Properties> commandStatsWrapper = Optional.ofNullable((Properties) redisTemplate.execute((RedisCallback<Object>) connection -> connection.serverCommands().info("commandstats")));
        ...
        commandStatsWrapper.ifPresent((commandStats)->{
